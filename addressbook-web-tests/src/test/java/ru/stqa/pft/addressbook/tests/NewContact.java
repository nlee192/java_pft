...
public class NewContact {
  ...
  public void testNewContact() throws Exception {
    ...
    fillContactForm(new NewContactData("Natasha", "Lee", "(123)1234567", "na@le.com", "123 Terra ln, Richmond, TX"));
    submitNewContact();
    returnHomePage();
  }
  ...
  private void fillContactForm(NewContactData newContactData) {
    ...
    wd.findElement(By.name("home")).sendKeys(newContactData.getPhonenumber());
